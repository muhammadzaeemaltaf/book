...
function testBasicQa() {
    return __awaiter(this, void 0, void 0, function () {
        var chatService, options, history, updatedOptions, clearedHistory;
        return __generator(this, function (_a) {
            ...
            options = chatService.getOptions();
            ...
            updatedOptions = chatService.getOptions();
            ...
            clearedHistory = chatService.getHistory();
...
// Run the test
testBasicQa().then(function (success) {
    if (success) {
